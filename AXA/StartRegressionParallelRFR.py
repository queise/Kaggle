...
def perform_analysis(folder, exten, STAND, means, stds, n_estimators=10, min_samples_leaf=1, max_depth=None):
    ...
    cls.classify(n_estimators=n_estimators, min_samples_leaf=min_samples_leaf, max_depth=max_depth)
    return cls.toKaggle()
...
if __name__ == '__main__':
    ...
    analysis(DataPath, MyPath, 5, exten, n_estimators, min_samples_leaf, max_depth)
