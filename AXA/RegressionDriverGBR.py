...
class RegressionDriver(object):
    ...
    def classify(self, n_estimators=100, learning_rate=0.1, max_depth=4):
        """Perform classification"""
        clf = GradientBoostingRegressor(n_estimators=n_estimators, learning_rate=learning_rate, max_depth=max_depth, random_state=13)
